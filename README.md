...
- Обработано уникальных YouTube-видео: 117.
- Доступно саммари: 117.
- Найдено сегментов в длинных трансляциях: 54.
- Сессий из официального расписания пока не найдено как отдельные видео или обоснованные сегменты: 495.
